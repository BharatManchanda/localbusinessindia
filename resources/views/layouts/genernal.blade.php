...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link
            ...
            onerror="this.onerror=null;this.href='{{ asset('assets/bootstrap-5.3.3-dist/css/bootstrap.min.css') }}';"
        >
...
<body>
    ...
    <script
        ...
        onerror="this.onerror=null;this.src='{{ asset('assets/bootstrap-5.3.3-dist/js/bootstrap.bundle.min.js') }}';"
    ></script>
</body>
</html>
